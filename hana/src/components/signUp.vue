<template>
  ...
  <div class="w100 ib  animate__animated animate__fadeIn">
    <div class="labelTop cntr" style="display:inline-block; text-align:left;">
      <div class="sign-up-container ft l sb bs cntr" style="width:70vw;background-color:white">
    <br/>
    <p class="signUpLabel ft primary l p3 pd10">Sign Up for GENERIC NAME</p>

    <div class="controlForm" style="width:40vw">
    <form @submit.prevent="submitForm" class="cntr">

      <div class="form-group">
        <div class="label-column">
          <label for="fullname" :style="{color: labelColors[4]}">Username *</label>
        </div>
        <div class="input-column f">
          <input id="fullname" class="inpClear inp" type="text" @focus="changeLabelColor(4)" @blur="resetLabelColor(4)" placeholder="Username" v-model="username"/>
        </div>
      </div>
